...
\huge Queues - Queue Implementation \\ % The assignment title
...
For this homework, you will be implementing a \textbf{linked list based} queue.
...
\begin{enumerate}
	...
	\item \textbf{FILES TO DOWNLOAD:} Queues.zip
	\item \textbf{FILES TO SUBMIT:} Queue.java
\end{enumerate}
...
To submit, please submit your Queue.java file.
